#!/usr/bin/env bash
source <(curl -fsSL https://raw.githubusercontent.com/gdadd/pve-scripts/main/misc/build.func)
...
function update_script() {
  ...
  if ! lsb_release -d | grep -q "Ubuntu 24.10"; then
    ...
    msg_error "Read Guide: https://github.com/gdadd/pve-scripts/discussions/1549"
    exit 1
  fi
